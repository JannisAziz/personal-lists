package de.jannisaziz.backend.filter;
...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    public JwtAuthFilter(JWTUtilService jwtUtilService, UserDetailsService userService) {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (token != null) try {
            ...
            if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                ...
                if (jwtUtilService.validateToken(token, userDetails.getUsername())) {
    ...
    private String getToken(HttpServletRequest request) {
        ...
        if (authHeader == null) {
            ...
            // "Bearer adsanvihjebnnb.sgaetnbetdn.avdbbsrt"
